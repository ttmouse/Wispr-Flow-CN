...
class SettingsWindow(QDialog):
    ...
    def __init__(self, parent=None, settings_manager=None, audio_capture=None):
        ...
        self.setMinimumWidth(480)  # 减少最小宽度
        self.setMinimumHeight(360)  # 减少最小高度
        ...
        # 创建主布局
        layout = QVBoxLayout()
        layout.setContentsMargins(8, 8, 8, 8)  # 减少窗口边距
        ...
        button_layout.setContentsMargins(0, 6, 0, 0)  # 减少按钮区域边距
    ...
    def _create_general_tab(self):
        ...
        tab = QWidget()
        layout = QVBoxLayout()
        layout.setContentsMargins(8, 8, 8, 8)  # 减少标签页边距
        layout.setSpacing(8)  # 减少组件间距
        
        # 热键方案设置组
        scheme_group = QGroupBox("热键方案设置")
        scheme_layout = QVBoxLayout()
        scheme_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        scheme_layout.setSpacing(4)  # 减少组内间距
        ...
        hotkey_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        hotkey_layout.setSpacing(4)  # 减少组内间距
        ...
        delay_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        delay_layout.setSpacing(4)  # 减少组内间距
    ...
    def _create_audio_tab(self):
        ...
        device_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        device_layout.setSpacing(4)  # 减少组内间距
        ...
        control_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        control_layout.setSpacing(4)  # 减少组内间距
    ...
    def _create_asr_tab(self):
        ...
        model_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        model_layout.setSpacing(4)  # 减少组内间距
        ...
        recognition_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        recognition_layout.setSpacing(4)  # 减少组内间距
    ...
    def _create_paste_tab(self):
        ...
        paste_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        paste_layout.setSpacing(4)  # 减少组内间距
    ...
    def _create_hotwords_settings_tab(self):
        ...
        weight_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        weight_layout.setSpacing(4)  # 减少组内间距
        ...
        correction_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        correction_layout.setSpacing(4)  # 减少组内间距
    ...
    def _create_hotwords_edit_tab(self):
        ...
        hotword_edit_layout.setContentsMargins(8, 8, 8, 8)  # 减少组内边距
        hotword_edit_layout.setSpacing(4)  # 减少组内间距
    ...
    def _create_dependency_tab(self):
        """创建依赖管理标签页"""
        try:
            # 创建依赖管理标签页
            ...
            retry_btn.clicked.connect(lambda: self._create_dependency_tab())
